...
/***/ 158:
/*!*****************************************************************!*\
  !*** /Users/jiaozi030/Desktop/app/QiuQiu/data/sampleProfile.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.sampleProfile = void 0;
var _sampleTags = __webpack_require__(/*! ./sampleTags.js */ 159);
var sampleProfile = {
  avatar: '/static/logo.png',
  ...
  housing: '自有住房',
  hasCar: true,
  tags: _sampleTags.sampleTags.tags.slice(0, 10),
  // 取前 10 个标签
  hobbies: _sampleTags.sampleTags.hobbies.slice(0, 10),
  // 取前 10 个兴趣
  expectation: _sampleTags.sampleTags.expectations.slice(0, 10).join('、') // 取前 10 个期望对象
};
...
var sampleTags = {
  tags: ['S型身材', '肤白貌美', '古灵精怪', '文艺女青年', '小魔女', '小仙女', '可甜可盐', '高冷', 'A4腰', '又纯又欲', '萝莉', '女汉子', '细节控', '慢热', 'Shopping魔', '宅女', '活力四射', '小麦肤色', '反射弧长', '微洁癖', '喜欢cd', 'TS药娘妹', '小乌依人', '活泼可爱', '不可救药多动症患者', '摇滚女青年', '贤内助', '傻白甜', '外冷内热', '热辣', '浪漫至死不渝', '猫性', '秀气', 'rap', '温柔体贴', '二次元', '软妹', '性感', '大长腿', '马甲线', '有洁癖', '呆萌', '微胖', '粘人', '卡哇伊', '欧美范儿', '乖乖女', '爱笑女孩', '筷子腿', '多才多艺', '嗲', '活泼开朗', '落落大方', '甜', '无法描述的好姑娘', '独立自主', '宅', '时尚', '野性', '腐女', '学霸', '怪', '妩媚'],
